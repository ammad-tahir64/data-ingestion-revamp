...
namespace e4scoreDataIngestionFunctionApp.Models.Enum
{
    ...
    public static class RedisKeys
    {
        ...
        /// <summary>device:imei:{imei} → DeviceCacheEntry (DeviceId, AssetId, CompanyId, DeviceType)</summary>
