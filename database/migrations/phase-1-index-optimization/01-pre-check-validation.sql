...
-- Purpose: Capture baseline state for ALL Phase 1 target tables
-- Save the full output of this script before proceeding to Step 2
-- =====================================================

-- =====================================================
-- 1. Index inventory for DeviceSummaries
-- =====================================================
PRINT '=== DeviceSummaries: Current Indexes ==='
SELECT
    i.name          AS IndexName,
...
-- =====================================================
-- 2. Index sizes for DeviceSummaries
-- =====================================================
PRINT '=== DeviceSummaries: Current Index Sizes (GB) ==='
SELECT
    i.name  AS IndexName,
...
-- =====================================================
-- 3. Index inventory for DeviceEvents
-- =====================================================
...
-- =====================================================
-- 4. Index sizes for DeviceEvents
-- =====================================================
...
-- =====================================================
-- 5. Index inventory for AdvanceTrackingSettingSummaries
-- =====================================================
...
-- =====================================================
-- 6. Index sizes for AdvanceTrackingSettingSummaries
-- =====================================================
...
-- =====================================================
-- 7. Index inventory for GeocodeLocationLogs
-- =====================================================
...
-- =====================================================
-- 8. Index sizes for GeocodeLocationLogs
-- =====================================================
...
-- =====================================================
-- 9. Index inventory for TrackedAssets
-- =====================================================
...
-- =====================================================
-- 10. DTU baseline — note the timestamp when you run this
-- =====================================================
